...
class base_complex_model1(nn.Module):
    def __init__(self):
        super(base_complex_model1, self).__init__()
...
class base_complex_model2(nn.Module):
    def __init__(self):
        super(base_complex_model2, self).__init__()
...
class base_complex_model(nn.Module):
    def __init__(self):
        ...
        self.base_complex_model1 = base_complex_model1()
        self.base_complex_model2 = base_complex_model2()

    def forward(self,x):
        x = self.base_complex_model1(x)
        embedding, output = self.base_complex_model2(x)
